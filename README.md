...
|---|---|---|
| Разработка | Таинственный код (Cryptic code). Подразумевает использование аббревиатур вместо мнемоичных имён. Приводит к нечитаемости кода.| Избегается путем документировании и введением регламентов на разработку |
