...
![none](https://github.com/imoldobaew/imoldobaew.github.io/blob/main/План-факт.png)
...
Эффект от автоматизации (человеко-часы в месяц): 3 чел/мес переводим в человеко-час, и получаем следующую формулу: 3 * 21 * 8 = 504 человеко-часы в месяц
