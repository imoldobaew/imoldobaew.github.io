...
Исходя из расчётов трудозатрат, полученных методом COCOMO II делаем вывод, что система является экономически выгодной (с учетом того, что программисты имеют низкие навыки) и может быть реализована за 5 месяцев командой из 3-х человек.

С применением системы экономия времени составит 324 часов в год на создании 6 выставок, в каждой из которых примерно 50 экспонатов.
Снижает вероятность ошибок при подготовке выставочного оборудования, приемке и раскладке материалов выставок, а так же при составлении светотеневого решения.

Плановое время, затраченное на разработку системы, составляет 5 мес, при трудоемкости 3 ч/мес. Создание системы: 5 мес = 750 часов на разработку.

Время съэкономленное предприятием составляет 324 ч/год, система разрабатывается один раз и при необходимости ее можно внедрить на несколько учреждений - разработку можно считать экономически выгодной.

На данный момент было выполнено 60%, поставленных в задании на выпускную работу, задач. Выполнение оставшихся 40% приходится на практическое исполнение описанных ранее действий, что вполне выполнимо до срока сдачи ВКР.
