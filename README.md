 ...
 **Выявленные проблемы:** Тратиться много ресурсов на создание/планирование музейной выставки\экспозиции

 **Требования:** Повысить эффективность планирования/создания музейной выставки без увеличения трудозатрат
...
4. Act (Улучшение): 
При успешной работе системы (сокращение временных затрат на проектирование), он внедряется в предприятие, с возможностью доработки или расширения функционала в дальнейшем
